...
const I18N = {
  en: {
    ...
    'factory.sub': '12,000 m² facility, 40+ machines and 5 production lines, with ISO 9001, SGS, BSCI and 1688 Super Factory status.',
    'factory.stat1': '12+', 'factory.s1': 'Years Experience',
    'factory.stat2': '12,000 m²', 'factory.s2': 'Factory Floor',
    'factory.stat3': '40+', 'factory.s3': 'Production Machines',
    'factory.stat4': '5 Lines', 'factory.s4': 'Production Lines',
    'brands.title': 'Trusted by Leading Brands',
    'brands.sub': 'OEM / ODM partner to sports and yoga brands around the world.',
    'brands.note': 'A partial list of brands we have served (for reference; not for resale):',
    ...
    'spec5.t': 'PU / Rubber Mat',
    'spec5.d': 'Natural rubber base + PU anti-slip top\n1830×610 / 1850×800 mm\nMOQ on request',
    'spec6.t': 'Yoga Wheel',
    'spec6.d': '12 / 15 cm diameter, PP core\nTPE or cork surface\nMOQ on request',
    ...
    'cat9.n': 'PU / Rubber Mats', 'cat9.s': 'Premium grip',
    'cat10.n': 'Suede Mats', 'cat10.s': 'Suede / velvet',
    'cat11.n': 'Foldable Mats', 'cat11.s': 'Travel friendly',
    'cat12.n': 'Massage Sticks', 'cat12.s': 'Deep tissue',
    'cat13.n': 'Yoga Wheels', 'cat13.s': 'Back & core',
    'cat14.n': 'Balance & BOSU', 'cat14.s': 'Balance pads',
    'cat15.n': 'Bath Mats', 'cat15.s': 'Non-slip home',
    ...
    'g12.n': 'Half Balance Ball', 'g12.s': 'BOSU / 波速球',
  ...
  zh: {
    ...
    'factory.title': '工厂一览',
    'factory.sub': '12000 ㎡ 厂房，40 余台设备、5 条生产线，通过 ISO 9001、SGS、BSCI 及 1688 超级工厂认证。',
    'factory.stat1': '12+', 'factory.s1': '年行业经验',
    'factory.stat2': '12000 ㎡', 'factory.s2': '厂房面积',
    'factory.stat3': '40+', 'factory.s3': '生产设备',
    'factory.stat4': '5 条', 'factory.s4': '生产线',
    'brands.title': '深受知名品牌信赖',
    'brands.sub': '为全球运动与瑜伽品牌提供 OEM / ODM 代工。',
    'brands.note': '曾服务品牌（仅作参考，不涉及转售）：',
    'range.title': '全系列产品',
    ...
    'spec5.t': 'PU / 橡胶垫',
    'spec5.d': '天然橡胶底 + PU 防滑面\n1830×610 / 1850×800 mm\n起订量 面议',
    'spec6.t': '瑜伽轮',
    'spec6.d': '直径 12 / 15 cm，PP 内胆\nTPE 或软木面\n起订量 面议',
    'proc.title': '合作流程',
    ...
    'about.p3': '工厂占地 12000 ㎡，拥有 40 余台生产设备、5 条生产线，可为瑜伽品牌、零售商及场馆连锁提供稳定的大规模供货。',
    ...
    'cat9.n': 'PU / 橡胶垫', 'cat9.s': '高端防滑',
    'cat10.n': '麂皮绒垫', 'cat10.s': '麂皮 / 绒面',
    'cat11.n': '折叠垫', 'cat11.s': '便携出行',
    'cat12.n': '按摩棒', 'cat12.s': '深层放松',
    'cat13.n': '瑜伽轮', 'cat13.s': '腰背核心',
    'cat14.n': '波速球 / 平衡垫', 'cat14.s': '平衡训练',
    'cat15.n': '浴室地垫', 'cat15.s': '居家防滑',
    'gallery.title': '全产品图库',
