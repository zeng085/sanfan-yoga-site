...
const I18N = {
  en: {
    ...
    'range4.t': 'Resistance Bands & Pilates', 'range4.s': 'Bands · Yoga Balls · Balance Pad', 'range4.alt': 'Resistance bands and pilates gear',
    'range5.t': 'Fitness Equipment', 'range5.s': 'Dumbbells · Kettlebells · Jump Rope · MMA', 'range5.alt': 'Fitness equipment',
    ...
    'g22.n': 'Balance Pad', 'g22.s': 'TPE stability pad',
    'g23.n': 'Silicone Dumbbell', 'g23.s': 'Anti-roll, floor-friendly',
    'g24.n': 'Kettlebell', 'g24.s': 'Functional strength',
    'g25.n': 'Jump Rope', 'g25.s': 'Ball-bearing speed rope',
    'g26.n': 'MMA Gloves', 'g26.s': 'Shock-absorbing training',
    ...
    'cat.bands.title': 'Resistance Bands & Pilates', 'cat.bands.sub': 'Bands · Yoga Balls · Balance Pad',
    'cat.fit.title': 'Fitness Equipment', 'cat.fit.sub': 'Dumbbells · Kettlebells · Jump Rope · MMA',
    ...
    'rb3.t': 'Yoga / Fitness Ball', 'rb3.d': 'Anti-burst yoga and fitness ball for core, balance and general training.',
    'rb4.t': 'Balance Pad', 'rb4.d': 'TPE balance pad for stability training, rehab and pilates; custom sizes and colors.',
    'fi1.t': 'Silicone Dumbbell', 'fi1.d': 'Silicone-wrapped dumbbells; anti-roll and floor-friendly; multiple weights and colors for home and gym lines.',
    ...
    'fi4.t': 'MMA Gloves', 'fi4.d': 'MMA training gloves with shock-absorbing padding; multiple sizes, custom logo and colorways.',
  ...
  zh: {
    ...
    'range5.t': '健身器材', 'range5.s': '哑铃 · 壶铃 · 跳绳 · MMA手套', 'range5.alt': '健身器材',
    ...
    'cat.fit.title': '健身器材', 'cat.fit.sub': '哑铃 · 壶铃 · 跳绳 · MMA手套',
    ...
    'fi4.t': 'MMA 手套', 'fi4.d': 'MMA 训练手套，减震加垫；多尺码，logo 与配色可定制。',
